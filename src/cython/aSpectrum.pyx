...
cdef class Spectrum:
  ...
  cdef object transferIsPossible(self, Atom atomA, Atom atomB, object expTransfer) :
    '''Returns whether a magnetization transfer is possible given
       given the two atoms and the type of transfer as determined by expTransfer.
       kwargs:  atomA:  atom where magnetization is currently stored.
                atomB:  atom where magnetization is transferred to.
                expTransfer:  ccpn ExpTransfer object describing the type
                              of magenetization transfer.
       Returns: Bool
    '''
  ...
  cdef double getIsotopomerAtomSetFractions(self,set isotopomers, set atomIsotopeTuples) :
    '''Returns the colabelling of atoms for the labelling
       ...
       isotopomers.
       kwargs:  isotopomers:        set of isotopomers to sum over.
                atomIsotopeTuples:  set of tuples containing information about
                                    atoms and their isotopeCode. Like
                                    (some_specific_atom_in_the_molecule, '13C').
       returns: double 0.0 to 1.0,  co-labelling fraction of atoms in the isotopomers.
  ...
  cdef void matchSequential(self):
    '''Matches simulated sequential cross-peaks to real peaks in the spectrum.
