...
class AnnealingSettingsTab(object):
    ...
    def body(self):
        ...
        label = Label(
            frame, text='Amount of attempts per temperature:', grid=(row, 0))
        ...
        label = Label(
            frame, text='Fraction of peaks to leave out:', grid=(row, 0))
        ...
        label = Label(
            frame, text='Minmal amino acid typing score:', grid=(row, 0))
        ...
        label = Label(
            frame, text='Minimal colabelling fraction:', grid=(row, 0))
        ...
        label = Label(
            frame, text='Include untyped spin systems:', grid=(row, 0))
        ...
        label = Label(
            frame, text='Use dimensional assignments:', grid=(row, 0))
    ...
    def addEnergyPoint(self, energy, time):
        ...
        self.energyPlot.update(
            dataSets=self.energyDataSets, dataColors=colorList)
